...
export default function SuccessConfirmation({ orderNumber }: { orderNumber: string }) {
      ...
      >
        ...
        <div className="space-y-4 mb-4 text-left">
          <p className="text-gray-700">
            Your payment was verified by Stripe. You can review the checkout and available invoice from your order history.
          </p>
          <p className="text-gray-700">
            Order Number:{" "}
