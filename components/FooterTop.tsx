...
interface ContactItemData {
  ...
  href?: string; // optional link for phone/email
}
...
const data: ContactItemData[] = [
  ...
  },
  {
    ...
    href: "tel:+12958648597", // phone link
  },
  {
    title: "Working Hours",
  ...
  },
  {
    ...
    href: "mailto:Shopcart@gmail.com", // email link
  },
];
        ...
        >
          ...
          <div>
            ...
            {item.href ? (
              <a
                href={item.href}
                className="text-gray-600 text-sm mt-1 group-hover:text-gray-900 hoverEffect block"
              >
                {item.subtitle}
              </a>
            ) : (
